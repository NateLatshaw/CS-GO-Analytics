...
df[, RoundState := relevel(factor(paste0('T', t_alive, 'CT', ct_alive)), ref = 'T4CT4')]
...
df[bomb_site == '', bomb_site := 'None']
df[, BombLocation := relevel(factor(paste(toupper(gsub('de_', '', map)), bomb_site)), ref = 'DUST2 None')]
